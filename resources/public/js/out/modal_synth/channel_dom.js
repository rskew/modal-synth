...
modal_synth.channel_dom.add_to = (function modal_synth$channel_dom$add_to(parent,element){
...
modal_synth.channel_dom.init = (function modal_synth$channel_dom$init(channel){
...
modal_synth.channel_dom.create = (function modal_synth$channel_dom$create(gain_fader_state,delay_fader_state,highpass_cutoff_state,lowpass_cutoff_state,id){
...
modal_synth.channel_dom.add_to.call(null,document.body,channel_element);

modal_synth.channel_dom.init.call(null,channel);
...
//# sourceMappingURL=channel_dom.js.map?rel=1490271369033