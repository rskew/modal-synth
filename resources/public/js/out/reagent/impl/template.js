...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25383__auto__,writer__25384__auto__,opt__25385__auto__){
return cljs.core._write.call(null,writer__25384__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__35080 = o;
(G__35080[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__35082__i < G__35082__a.length) {G__35082__a[G__35082__i] = arguments[G__35082__i + 0]; ++G__35082__i;}
  args = new cljs.core.IndexedSeq(G__35082__a,0);
} 
...
var args = cljs.core.seq(arglist__35083);
...
if(cljs.core.truth_((function (){var and__24765__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__24765__auto__){
var and__24765__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__35089 = jsprops;
(G__35089["defaultValue"] = value);

(G__35089["onChange"] = ((function (G__35089,v,value,on_change){
return (function (p1__35086_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__35086_SHARP_);
});})(G__35089,v,value,on_change))
);

(G__35089["ref"] = ((function (G__35089,v,value,on_change){
return (function (p1__35087_SHARP_){
return (this$["cljsInputElement"] = p1__35087_SHARP_);
});})(G__35089,v,value,on_change))
);
...
var vec__35096 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__35096,(0),null);
var id = cljs.core.nth.call(null,vec__35096,(1),null);
var class$ = cljs.core.nth.call(null,vec__35096,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___35101 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___35101 == null)){
} else {
var key_35102 = temp__4661__auto___35101;
(jsprops["key"] = key_35102);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__35104 = (new reagent.impl.template.NativeWrapper());
(G__35104["name"] = c);
...
var len__25852__auto___35110 = arguments.length;
var i__25853__auto___35111 = (0);
while(true){
if((i__25853__auto___35111 < len__25852__auto___35110)){
args__25859__auto__.push((arguments[i__25853__auto___35111]));

var G__35112 = (i__25853__auto___35111 + (1));
i__25853__auto___35111 = G__35112;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25860__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35108){
var G__35109 = cljs.core.first.call(null,seq35108);
var seq35108__$1 = cljs.core.next.call(null,seq35108);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__35109,seq35108__$1);
});
...
break;
default:
var G__35116 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__35116;
continue;
...
var n__25692__auto___35119 = a.length;
var i_35120 = (0);
while(true){
if((i_35120 < n__25692__auto___35119)){
(a[i_35120] = reagent.impl.template.as_element.call(null,(a[i_35120])));

var G__35121 = (i_35120 + (1));
i_35120 = G__35121;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25692__auto___35122 = a.length;
var i_35123 = (0);
while(true){
if((i_35123 < n__25692__auto___35122)){
var val_35124 = (a[i_35123]);
if((cljs.core.vector_QMARK_.call(null,val_35124)) && ((reagent.impl.template.key_from_vec.call(null,val_35124) == null))){
(o["no-key"] = true);
} else {
}

(a[i_35123] = reagent.impl.template.as_element.call(null,val_35124));

var G__35125 = (i_35123 + (1));
i_35123 = G__35125;
continue;
} else {
}
...
var ctx = ({});
var vec__35129 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__35129,(0),null);
var derefed = cljs.core.nth.call(null,vec__35129,(1),null);
...
var G__35133 = (cljs.core.count.call(null,argv) - first_child);
switch (G__35133) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__35133){
...
//# sourceMappingURL=template.js.map?rel=1485855397274